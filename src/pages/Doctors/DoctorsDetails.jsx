        ...
        <div className='md:col-span-2'>
          ...
          <div className='flex items-center gap-5'>
            ...
            <div>
              ...
              <p className='text__para text-14px] leading-6 lg:max-w-[390px] md-text-[15px]'>I'm Dr.Jeon Roowoon,  With years of training and experience,
                I specialize in general surgery.  </p>
            </div>
          </div>
